...
export type CryptoCurrencyDto = Yup.InferType<typeof CryptoCurrencyValidationScheme>
...
export function convertToCryptoCurrency(dto: CryptoCurrencyDto): CryptoCurrency {
    return {
        ...
        change: parseFloat(dto.price_change_percentage_24h ?? '0.0').toFixed(2).toString(),
