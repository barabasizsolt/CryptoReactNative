...
import { cryptoCurrencyDetailConverter, fetchCryptoCurrencyDetail } from "../data/service/CryptoCurrencyDetailService"

export let getCryptoCurrencyDetail = async (id: string): Promise<Result<CryptoCurrencyDetail>> => wrapToResult(
