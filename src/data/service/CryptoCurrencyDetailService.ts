...
export let fetchCryptoCurrencyDetail = (
    id: string = "bitcoin"
): Promise<AxiosResponse<CryptoCurrencyDetail>> => axiosInstance.get(
    `coins/${id}`,
    { params: { localization: false } }
)

export let cryptoCurrencyDetailConverter = (dto: any): CryptoCurrencyDetail => convertToCryptoCurrencyDetail(dto)